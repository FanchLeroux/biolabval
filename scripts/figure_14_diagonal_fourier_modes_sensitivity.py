...
utc_imat = "utc_2026-06-24_17-14-22"  # fourier modes imat
...
fig_sensitivities.supxlabel("# Cycles per pupil", fontsize=fontsize_label, x=0.6)

for ax in axs:
    ax.tick_params(axis="both", labelsize=fontsize_tick)

fig_name = f"figure_14_diagonal_fourier_modes_sensitivity.pdf"
