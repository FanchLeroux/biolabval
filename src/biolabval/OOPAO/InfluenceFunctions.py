...
from biolabval.OOPAO.tools.tools import OopaoError, centroid
...
class InfluenceFunctions:
    ...
    def _get_compute_function(name_system: str):
        ...
        from biolabval.OOPAO.tools import user_defined_influence_functions as udif

        dispatch = {
            "ELT_M4": udif.compute_ELT_M4_influence_functions,
